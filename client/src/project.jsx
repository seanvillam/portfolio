...
export default function Project() {
    ...
    <div>
     ...
     <div class="flexbox">
        <div class="card">
            <img src="./assets/library.png" alt="Project 1" style={{ width: "100%" }} />
            <div class="container">
        ...
        <div class="card">
            <img src="./assets/todo.png" alt="Project 2" style={{ width: "100%" }} />
            <div class="container">
                <h3>Task Board</h3>
        ...
        <div class="card">
            <img src="./assets/shopping.png" alt="Project 3" style={{ width: "100%" }} />
            <div class="container">
